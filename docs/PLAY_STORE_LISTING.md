...
## Content and audience notes

- No ads.
- No user account or sign-in.
- No user-generated public content.
- No chat, social features, or location features.
- Intended for general audiences and music learners.

These notes are a preparation aid only; complete the official Play Console questionnaires for the final release.

## Support

<https://github.com/uniquelydrew/midi-game-engine/issues>
